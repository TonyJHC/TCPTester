...
public class SampleLight {
	public static void main(String[] args) {
		...
		try {
			...
			// 숫자형 다건 전송
			transID = IMUtil.getTransactionLongRoundKey4();
			Map<String, Double> numberRows = new HashMap<String, Double>(); // <Key, Value>
			...
			// 해제 및 종료
			//imTcpConnector.deactivate(); // 해당 코드로 인해 로그가 안찍힘 ( 3: 수집패킷을 전달하고 연결을 끊기 때문 )
